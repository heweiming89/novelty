var FormValidation = function() {
    ...
    var handleValidation2 = function() {
        ...
        $(document).on("click", "#form2CancelBtn", function() {
            console.info(1111);
...
//            form2Validator.form();
    ...
    var handleValidation3 = function() {
        ...
        $('.select2me', form3).change(function() {
            form3.validate().element($(this)); // revalidate the chosen
            // dropdown value and show error
            // or success message for the
            // input
        });
